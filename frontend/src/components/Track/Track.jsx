...
export default function Track({chartPosition=null}) {
    return (
        <div className="track">
            <div className="track__inner">
                <div className="track__info">
                    <ButtonLink to={'/'} className="track__image-link">
                        <img src={trackImage} height={44} width={44} loading='lazy' alt="" className="track__image"/>
                    </ButtonLink>
                    <div className="track__body">
                        ...
                        <ButtonLink to={'/'} className="track__author">Vanya Dmitrienko</ButtonLink>
                    </div>
                </div>
